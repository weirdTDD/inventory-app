      ...
      <div className='container mx-auto px-4 py-16'>
        <div className='text-center'>
          <h1 className='text-5xl font-bold text-shadow-lg text-gray-900 mb-8'>
           <span className="text-purple-600">Ed&apos;s</span> Inventory Management
          </h1>
          <h3 className="text-2xl mb-8 font-mono font-bold text-purple-600 text-shadow-lg">Your perfect Management system</h3>
          ...
          <div className='flex gap-6 justify-center'>
            <Link 
            href="/sign-in"
            className= " bg-purple-600 text-white px-12 py-3 rounded-lg font-semibold hover:bg-purple-800 shadow-xl transition-colors "
            >
              Sign In
            </Link>
            <Link
